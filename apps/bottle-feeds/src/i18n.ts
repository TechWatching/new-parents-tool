...
export const messages = {
  en: {
    ...
    timeSinceLastBottleFormat: 'Time since last bottle {relativeTime} ({timestamp})',
    today: 'Last 24 hours',
    bottles: 'bottles',
  ...
  fr: {
    ...
    timeSinceLastBottleFormat: 'Temps depuis le dernier biberon {relativeTime} ({timestamp})',
